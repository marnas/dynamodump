...
func init() {
	...
	backupCmd.Flags().StringVarP(&dynamoTableAccountID, "dynamo-table-account-id", "x", "", "AccountID that will be used to access the dynamoDB")
	...
	backupCmd.Flags().StringVarP(&dynamoTableRole, "dynamo-table-role", "c", "OrganizationAccountAccessRole", "Role that will be used to access the dynamoDB")
	...
	backupCmd.Flags().StringVarP(&s3BucketAccountID, "s3-bucket-account-id", "e", "", "AccountID that will be used to access the s3 Bucket")
	...
	backupCmd.Flags().StringVarP(&s3BucketRole, "s3-bucket-role", "g", "OrganizationAccountAccessRole", "Role that will be used to access the s3 Bucket")
