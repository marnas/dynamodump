...
func init() {
	...
	backupCmd.Flags().StringVarP(&awsProfile, "aws-profile", "a", "", "Name of the AWS profile as provided in the credentials file. Environment variable: AWS_PROFILE (required)")
	...
	backupCmd.Flags().StringVarP(&dynamoTableRole, "dynamo-table-role", "dr", "", "Role that will be used to access the dynamoDB")
	...
	backupCmd.Flags().StringVarP(&s3BucketRole, "s3-bucket-role", "sr", "", "Role that will be used to access the s3 Bucket")
	...
	backupCmd.MarkFlagRequired("aws-profile")
